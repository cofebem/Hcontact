...
matrix $S_{ij}$ equal to the Love (1929) closed-form integral of $G$ over a
source element, evaluated at a target element centre. Because the geometry
...
solved by the Polonsky--Keer projected conjugate gradient (see
\texttt{doc/theory/pcg.tex}). \textbf{Each PCG iteration needs two
...
The previous Hcontact backend was a classical $\mathcal{H}$-matrix: a list of
admissible blocks, each compressed independently as $A_{ts}\approx U_{ts}
...
product. This is exactly black-box FMM: only kernel \emph{evaluations} are
needed, never analytic multipole expansions.
...
W.~Fong, E.~Darve, \emph{The black-box fast multipole method},
J.\ Comput.\ Phys.\ 228 (2009) 8712--8725. \;
W.~Hackbusch, \emph{Hierarchical Matrices}, Springer 2015. \;
A.~A.~Polonsky, L.~M.~Keer, \emph{Wear} 231 (1999) 206--219. \;
A.~E.~H.~Love (1929) rectangular-patch surface displacement.
